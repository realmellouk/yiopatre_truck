...
const i18nTranslations = {
    en: {
        ...
        reviews_no: "No reviews yet. Be the first!",
        review_write: "Write a Review",
        review_name_placeholder: "Your name",
        review_text_placeholder: "Share your experience with this product...",
        review_submit: "Submit Review",
        review_success: "Review submitted! Thank you.",
        review_warn_name: "Please enter your name.",
        review_warn_rating: "Please select a star rating.",
        review_warn_text: "Please write a review.",
        reviews_count_single: "review",
    ...
    fr: {
        ...
        reviews_no: "Aucun avis pour l'instant. Soyez le premier !",
        review_write: "Écrire un Avis",
        review_name_placeholder: "Votre nom",
        review_text_placeholder: "Partagez votre expérience avec ce produit...",
        review_submit: "Soumettre l'Avis",
        review_success: "Avis soumis ! Merci.",
        review_warn_name: "Veuillez entrer votre nom.",
        review_warn_rating: "Veuillez sélectionner une note.",
        review_warn_text: "Veuillez écrire un avis.",
        reviews_count_single: "avis",
    ...
    ar: {
        ...
        reviews_no: "لا توجد تقييمات بعد. كن الأول!",
        review_write: "اكتب تقييماً",
        review_name_placeholder: "اسمك",
        review_text_placeholder: "شارك تجربتك مع هذا المنتج...",
        review_submit: "إرسال التقييم",
        review_success: "تم إرسال التقييم! شكراً لك.",
        review_warn_name: "يرجى إدخال اسمك.",
        review_warn_rating: "يرجى اختيار تقييم بالنجوم.",
        review_warn_text: "يرجى كتابة تقييم.",
        reviews_count_single: "تقييم",
        reviews_count_plural: "تقييمات",
